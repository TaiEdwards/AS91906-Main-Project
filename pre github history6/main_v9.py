...
def draw_menu():
    ...
    text_image = font.render('Start Game', True, (0, 0, 0))
...
if __name__ == "__main__":
    ...
    gametitle = Button(800, 50, 450, 150, "Game Title Placeholder", font, COLOR_BLACK, 1, COLOR_BLACK)
    gamesubtitle = Button(240, 220, 450, 50, "BY TAI EDWARDS", font, Color_None, 0, Color_None)
    menusnake = Button(20, 250, 150, 300, "Snake Image Placeholder", font, COLOR_BLACK, 1, COLOR_BLACK)
